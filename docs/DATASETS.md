...
Local CPJUMP1 files are optional review/runtime inputs and should remain outside git. The Phase 2 path covers profile infrastructure and diagnostics; raw microscopy images, VLM baselines, and text-query/RAG support remain later project layers.
